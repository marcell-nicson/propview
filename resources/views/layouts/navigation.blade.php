<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('corretor')" :active="request()->routeIs('corretor')">
                        {{ __('Corretores') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('visita')" :active="request()->routeIs('visita')">
                        {{ __('Visitas') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('imovel')" :active="request()->routeIs('imovel')">
                {{ __('Imóveis') }}
            </x-responsive-nav-link>
